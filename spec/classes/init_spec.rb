...
describe 'django' do
  ...
  context 'CentOS' do
    ...
    context '7' do
      ...
      it { should contain_class('django::source').with(:revision => 'master') }
    end
  ...
  context 'Debian' do
    ...
    context '7' do
      let(:operatingsystemmajrelease) { '7' }
      it { should contain_class('django::package') }
    end
  ...
  context 'default params' do
    ...
    it 'should install from package' do
      should contain_class('django::package')
    end
  end
  ...
  context 'custom params' do
    ...
    it 'should install from source' do
      should contain_class('django::source').with({
  ...
  it { should contain_anchor('django::begin') }
  it { should contain_anchor('django::end') }
end
